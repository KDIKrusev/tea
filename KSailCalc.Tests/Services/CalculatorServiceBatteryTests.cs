...
public class CalculatorServiceBatteryTests
{
    ...
    public async Task Level1_WithBatteryAdjustment_CarriesHigherDemand()
    {
        ...
        var without = await factory.Level1Service.FindOptimalCombinationAsync(input, OperationalMode.Transit);
        var with = await factory.Level1Service.FindOptimalCombinationAsync(
            input, OperationalMode.Transit, batteryAdjustment: new BatteryL1Adjustment(100, 50));
    ...
    public async Task Level1_WithBatteryAdjustment_DefaultsBaselineToThirdHighest()
    {
        ...
        var result = await factory.Level1Service.FindOptimalCombinationAsync(
            input, OperationalMode.Transit, batteryAdjustment: new BatteryL1Adjustment(0, 0));
    ...
    public async Task Level1_WithBatteryAdjustment_ExplicitBaselineIndexStillWins()
    {
        ...
        var result = await factory.Level1Service.FindOptimalCombinationAsync(
            input, OperationalMode.Transit, baselineIndex: 0,
    ...
    public async Task Level1_WithoutBattery_KeepsWorstCombinationAsDefaultBaseline()
    {
        ...
        var result = await factory.Level1Service.FindOptimalCombinationAsync(input, OperationalMode.Transit);
    ...
    public async Task OptimizedFuelSplit_FollowsOptimalCombinationRatio_NotBaseline()
    {
        ...
        var l1 = await factory.Level1Service.FindOptimalCombinationAsync(
            input, OperationalMode.Transit, batteryAdjustment: new BatteryL1Adjustment(372.5475, 72.2));
