...
public class Level3ResidualVariationTests
{
    ...
    private static CalculatorInput WithVariation(
    ...
    public async Task Level3_HotelBand_ReducesVariation_AndReportsShavedAmount()
    {
        ...
        var without = factory.Level3Service.CalculateDrcSavings(l2, input, factory.Curves, 5000);
        var with = factory.Level3Service.CalculateDrcSavings(l2, input, factory.Curves, 5000, batteryHotelPeakShavingKw: 200);
    ...
    public async Task Level3_BandCoversFullVariation_ZeroDrcSavings()
    {
        ...
        var result = factory.Level3Service.CalculateDrcSavings(l2, input, factory.Curves, 5000, batteryHotelPeakShavingKw: 800);
    ...
    public async Task Level3_ZeroBand_IdenticalToPreChangeBehaviour()
    {
        ...
        var implicitDefault = factory.Level3Service.CalculateDrcSavings(l2, input, factory.Curves, 5000);
        var explicitZero = factory.Level3Service.CalculateDrcSavings(l2, input, factory.Curves, 5000, batteryHotelPeakShavingKw: 0);
